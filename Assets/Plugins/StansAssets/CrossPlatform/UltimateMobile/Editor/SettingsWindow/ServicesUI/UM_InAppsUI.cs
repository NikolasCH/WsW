...
namespace SA.CrossPlatform
{
    public class UM_InAppsUI : UM_ServiceSettingsUI
    {
        ...
        public class ISNSettings : UM_NativeServiceLayoutBasedSetting
        {
            ...
            {
                get { return ISN_Preprocessor.GetResolver<ISN_StoreKitResolver>().IsSettingsEnabled; }
            }
        }
        ...
        public class ANSettings : UM_NativeServiceLayoutBasedSetting
        {
            ...
            public override bool IsEnabled 
            {
                get { return AN_Preprocessor.GetResolver<AN_VendingResolver>().IsSettingsEnabled; }
            }
        }
        ...
        public override void OnLayoutEnable() {
            ...
            AddFeatureUrl("Advanced use cases", "https://unionassets.com/ultimate-mobile-pro/advanced-use-cases-849");
        ...
        {
            get { return UM_Skin.GetServiceIcon("um_market_icon.png"); }
        }
