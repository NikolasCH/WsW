...
public class GameCenterAI : MonoBehaviour {
	...
	private const string LEADERBOARD_ID = "CgkIhYqZveMVEAIQAA";
	...
	{
		Debug.Log("onSubmitScore");
		GooglePlayManager.instance.submitScore (LEADERBOARD_NAME, result);
	}
