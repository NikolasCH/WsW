...
public class baza : MonoBehaviour {
	...
	public static  string[,]	words = new string[,]{
		...
		{"пассажир","12","жир,пас,рис,сир,пар,ржа,жар,пир,рапс,жара,париж,расса"},
		{"жадность","12","оса,нос,нож,сад,сон,тон,дно,ось,нота,сода,сжать,стадо"},
		...
		{"молекула","12","мел,ком,лом,кум,кол,лук,лак,мак,мука,укол,ломка,омела"},
		{"блокада","12","бал,бак,код,лак,лоб,кол,бок,док,клад,блок,лодка,бокал"},
		{"живность","12","тон,ось,инь,сто,нос,сон,нож,сот,вино,винт,стон,живот"},
		{"крокодил","12","лор,код,кол,рол,рок,род,око,док,лорд,крик,ролик,окрик"},
		{"аэроплан","12","эра,лор,пар,рэп,рол,пан,пол,пора,план,лапа,напор,рапан"},
		{"декольте","12","лот,ель,код,кол,ток,кот,док,лед,лето,лето,колье,отель"},
		{"живность","12","тон,ось,инь,сто,нос,сон,нож,сот,вино,винт,стон,живот"},
		{"единорог","12","год,гид,род,рог,дно,ген,ирод,один,ринг,горе,город,орден"},
		{"двоечник","12","чин,дно,век,чек,вид,код,док,дон,очки,кино,венок,видео"},
		{"сетчатка","12","акт,сет,чек,чат,час,кат,сак,скат,тест,такт,сетка,текст"},
		...
		{"мистика","12","акт,икс,иск,кат,кит,мат,сак,тик,аист,смак,миска,такси"},
		{"виселица","12","ева,лев,лес,вес,вал,лис,слив,лиса,сила,слива,весла,слева"},
		{"вестник","12","сет,век,кит,иск,ник,вес,свет,винт,твин,веник,вести,кисет"},
		{"карамель","12","ера,лак,мак,мел,рак,арка,кара,крем,мрак,рама,ларек,рамка"},
		...
		{"обмолвка","12","бак,кол,мак,лом,ком,лоб,вол,блок,овал,волк,колба,облом"},
		...
		{"абориген","12","бег,ген,раб,герб,горб,небо,ринг,рога,аргон,бпрон,гиена,регби"},
		{"барвинок","12","бак,ива,рок,банк,вино,икра,кино,нора,брови,икона,кобра,набор"},
